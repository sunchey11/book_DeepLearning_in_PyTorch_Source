# https://pytorch.org/vision/main/auto_examples/plot_transforms_v2_e2e.html
# 这篇文章的例子可以显示物品的边界，想看看怎么做的
# 发现此例子只是显示了一个边框，边框是通过coco检测的，结果放在instances.json中
# 没时间看coco,https://cocodataset.org/#format-data
"""
==================================================
...
def load_example_coco_detection_dataset(**kwargs):
    ...
    asserts_dir = os.path.join(file_dir, "assets")

    root = pathlib.Path(asserts_dir) / "coco"
